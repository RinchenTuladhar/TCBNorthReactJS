  ...
  return (
    <div className="home-page">
      ...
      <div className="content">
        ...
        <p>
        Our primary objective is to create a common platform where Tibetans and their families are able to generate a thriving community in the North of England.
        </p>
        <p>
